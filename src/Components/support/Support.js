...
const Support = () => {
    return (
        ...
        <h1 className="subheading"><span>FAQ</span> </h1>
        <Faq
            data={data}
            styles={styles}
            config={config}
        />
    <Contact subheading="need any help?"/>
    <div className="privacy-policy">
    <h1 className="subheading"><span>our </span>privacy policy </h1>
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to hallocreper, address.
...
Website refers to hallocreper, accessible from http://www.mysite.com
...
By visiting this page on our website: http://www.mycompany.com/contact</p>
        </div>
    </div>
    )
}
